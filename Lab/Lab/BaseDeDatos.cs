...
namespace Lab
{
    public class BaseDeDatos
    {
        ...
        public static List<Object> todos = new List<Object> { PeterJackson, GeorgeLucas, CenturyFox, ColumbiaPictures, ESdlA, StarWars, WillSmith, CeciliaBolocco, StevenSpielBerg, AngelinaJolie };
